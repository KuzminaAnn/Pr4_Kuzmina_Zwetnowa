...
Вывод: Проведенное тестирование не выявило ошибок, что означает абсолютно верное математическое решение уравнений. Код был написан
с учётом всех вариантов введенных числовых данных и проверен порядком 8 тестирваний. 
